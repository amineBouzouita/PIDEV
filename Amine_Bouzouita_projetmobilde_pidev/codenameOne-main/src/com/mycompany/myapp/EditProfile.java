...
public class EditProfile extends SideMenuBaseForm {
    ...
    public EditProfile(Resources res) {
        ...
        TextField address = new TextField( SessionManager.getAddress());
        ...
        addPub.addActionListener(l -> {
            ...
            userService.getInstance().editUser(SessionManager.getId(), tel.getText().toString(), address.getText().toString(), password.getText().toString());
            iDialog.dispose();
