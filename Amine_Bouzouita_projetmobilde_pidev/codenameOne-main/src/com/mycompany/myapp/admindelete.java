 ...
 * @author louay
 */
public class admindelete extends SideMenuBaseForm {

    public admindelete(Resources res) {
        super(BoxLayout.y());
        ...
        TextField address = new TextField( "id...");
        ...
        Button addPub = new Button("supprimer");
        ...
        addPub.addActionListener(l -> {
            ...
            userService.getInstance().deleteUseradmin(  address.getText());
            iDialog.dispose();
